    ...
    <section className="bg-[#1A1A1A] section-padding">
      <div className="max-w-[1180px] mx-auto flex flex-col items-center gap-12 md:gap-16">
        <div className="flex flex-col items-center gap-6 md:gap-8 text-center">
          ...
          <h2 className="font-['Radley'] text-fluid-section text-white leading-[1.2] max-w-[18ch]">
          ...
          {rows.map((row, i) => (
            ...
            >
              <div className="md:w-[400px] md:shrink-0 flex items-center md:border-r border-white/30 py-6 md:px-10 md:py-7">
                <p className="font-['JetBrains_Mono'] font-bold uppercase tracking-[0.22em] text-[13px] md:text-[15px] text-white leading-[1.5]">
                  {row.label}
                </p>
              </div>
              <div className="flex-1 flex items-center pb-6 md:px-10 md:py-7">
                <p className="font-['Lexend'] font-light text-[15px] md:text-[16px] text-white leading-[1.5]">
                  {row.description}
                </p>
              </div>
            </div>
