      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-10 md:mb-24">
          ...
          <div className="md:col-span-7 flex flex-col md:pt-16">
            <p className="font-['Lexend'] font-light text-[16px] text-[#C8CDD2] leading-[1.65] max-w-[56ch]">
              Every Thamserku expedition is supported by the Yeti Group
              operating foundation — quietly, throughout the season. Air
              coordination, mountain lodges, regional permits, and field
              continuity work in the background so the climb in front of you
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10 md:mb-24">
          {PILLAR_LABELS.map(({ label }, idx) => (
            <div
              key={idx}
              className="flex flex-col border-t border-[#C8CDD2]/30 bg-[#2A3036]/20 p-8 md:p-10"
            >
