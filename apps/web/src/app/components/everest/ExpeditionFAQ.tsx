      ...
      <div className="relative z-10 w-full max-w-[880px] mx-auto px-8 flex flex-col items-center">
        <div className="flex flex-col items-center text-center mb-24 md:mb-32">
          <span className="font-['JetBrains_Mono'] uppercase tracking-[0.22em] text-[11px] text-[#C8CDD2] mb-8">
            FREQUENTLY ASKED{expeditionName ? ` — ${expeditionName.toUpperCase()}` : ''}
          </span>
        ...
        {items.length > 0 && (
          <div className="w-full flex flex-col mb-24 border-b border-[#C8CDD2]/30">
            {items.map((faq, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col border-t border-[#C8CDD2]/30">
                  <button
                  ...
                  >
                    ...
                    <span className={`font-['JetBrains_Mono'] text-[14px] text-[#C8CDD2] transition-all duration-[250ms] ease-out transform ${isOpen ? 'rotate-180' : 'rotate-0'}`}>
                      ▾
                    </span>
                  </button>
                  <div
