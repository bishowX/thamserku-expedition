...
export function ExpeditionClosing({ name, closingImage, closingStatement, slug }: Props) {
 ...
 <section className="relative bg-[#1A1A1A] w-full min-h-[80vh] flex items-center justify-center text-center px-8 py-24 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-[800px] w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
          ...
          >
            Schedule a{name ? ` ${name}` : ''} Consultation <ArrowRight className="w-4 h-4" strokeWidth={1} />
          </Link>
          <Link
            to="/editions"
