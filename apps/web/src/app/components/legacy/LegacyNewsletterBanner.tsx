 ...
 <section className="w-full bg-[#F4F2EC] section-padding flex justify-center">
      <div className="w-full max-w-[880px] flex flex-col items-center text-center">
        ...
        <h2 className="font-['Radley'] font-light text-[44px] md:text-[56px] text-[#1A1A1A] leading-tight max-w-[26ch] mb-6">
          "{page?.newsletterHeading ?? 'A quiet letter, four times a year.'}"
        </h2>

        <p className="font-['Lexend'] text-[#5A6673] text-[16px] leading-[1.7] max-w-[60ch] mb-12">
          {page?.newsletterBody ?? 'Field reports, route judgements, and Himalayan readings from our expedition desk. No marketing. No frequency beyond what is honest. Unsubscribe anytime.'}
        </p>
        ...
        <p className="font-['JetBrains_Mono'] uppercase tracking-[0.22em] text-[10.5px] text-[#5A6673]">
          {page?.newsletterPrivacyNote ?? 'BY SUBSCRIBING YOU AGREE TO OUR PRIVACY TERMS. WE WILL NEVER SHARE YOUR DETAILS.'}
        </p>
      </div>
    </section>
  );
