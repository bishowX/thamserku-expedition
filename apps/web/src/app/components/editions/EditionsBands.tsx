          ...
          >
            ...
            <div className="relative z-10 w-full max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
              <div className="col-span-1 md:col-span-5 relative flex flex-col pt-8">
                ...
                <div className={`font-['Radley'] font-light leading-none ${ed.isFlagship ? 'text-[240px] md:text-[380px]' : 'text-[200px] md:text-[320px]'} -ml-4 ${letterColor}`}>
                  {ed.letter}
                </div>
                {ed.tag && (
              ...
              <div className="col-span-1 md:col-span-7 flex flex-col">
                ...
                <h3 className={`font-['Radley'] font-light ${ed.isFlagship ? 'text-5xl md:text-[80px]' : 'text-5xl md:text-[64px]'} mb-6 ${isDark ? 'text-white' : 'text-[#1A1A1A]'}`}>
                  {ed.name}
                </h3>

                {ed.subtitle && (
                  <p className={`font-['Radley'] italic text-[24px] md:text-[28px] mb-12 ${sigColor}`}>
                    {ed.subtitle}
                  </p>
                )}

                <div className={`font-['Lexend'] font-light text-[16px] leading-relaxed max-w-[56ch] mb-16 ${copyColor}`}>
                ...
                <div className="flex flex-col gap-10 max-w-[56ch]">
                  {ed.targetAudience && (
                    <div>
                      ...
                      <p className={`font-['Lexend'] font-light italic text-[15px] leading-relaxed ${copyColor}`}>
                        {ed.targetAudience}
                      </p>
                    </div>
                  )}
                  ...
                  {mountains && (
                    <div>
                      ...
                      <p className={`font-['JetBrains_Mono'] uppercase tracking-[0.1em] text-[13px] ${isDark ? 'text-[#C8CDD2]' : 'text-[#5A6673]'}`}>
                        {mountains}
                      </p>
                    </div>
                  )}
                  ...
                  {ed.isFlagship ? (
                    <>
                      ...
                      <Link
                        ...
                        className={`px-8 py-4 font-['JetBrains_Mono'] uppercase tracking-[0.22em] text-[11px] transition-colors border border-transparent ${
                          isDark
                    ...
                    <>
                      <Link
                        to={ed.slug?.current ? `/editions/${ed.slug.current}` : '/editions'}
                        className={`px-8 py-4 font-['JetBrains_Mono'] uppercase tracking-[0.22em] text-[11px] transition-colors border ${
                          isDark
                            ? 'border-white text-white hover:bg-white hover:text-[#0A3A77]'
                            : 'border-[#0A3A77] text-[#0A3A77] hover:bg-[#0A3A77] hover:text-white'
                        }`}
