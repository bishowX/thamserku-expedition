type PageData = { manifestoPullQuote?: string; manifestoBody1?: string; manifestoBody2?: string };

export function TeamManifesto({ page }: { page?: PageData }) {
  return (
