    ...
    <section className="relative py-24 overflow-hidden" style={{ background: 'linear-gradient(90deg, #2E353C 0%, #2E353C 100%)' }}>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-8">
        <div className="mb-10 md:mb-24">
          ...
          <h2 className="font-['Fraunces'] font-light text-display-l text-white max-w-[22ch]">
            {heading}
          </h2>
        </div>
          ...
          {steps.map((step) => (
            <div key={step._key} className="flex flex-col">
              <div className="w-12 h-12 rounded-full border border-[#C8CDD2] flex items-center justify-center mb-8">
                <span className="font-['Fraunces'] font-light text-[#C8CDD2] text-body">{step.stepNumber}</span>
              </div>
              <p className="font-['DM_Mono'] uppercase tracking-[0.22em] text-[11px] text-[#5A6673] mb-4">
                {step.marker}
              </p>
              <h3 className="font-['Fraunces'] text-display-m text-white mb-4">
                {step.title}
              </h3>
        ...
        <div className="text-center pt-12 border-t border-[#2E353C]">
          <p className="font-['Fraunces'] italic text-[#C8CDD2] text-body max-w-[60ch] mx-auto">
            {footnote}
          </p>
        </div>
      </div>
