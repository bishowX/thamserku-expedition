...
export const TrustStatement = ({ data }: { data?: ConsultationPage }) => {
  ...
  return (
    <section className="w-full bg-[#1A1A1A] section-padding flex justify-center">
      <div className="w-full max-w-[880px] flex flex-col items-center text-center">
        ...
        <h2 className="font-['Radley'] font-light text-[32px] md:text-[48px] text-white leading-[1.15] max-w-[28ch] mb-6">
          {quote}
        </h2>
