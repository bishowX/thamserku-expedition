 ...
 <section className="bg-[#F4F2EC] py-24">
      <div className="max-w-[1440px] mx-auto px-8">
        ...
        <div className="mb-10 md:mb-24">
          ...
          <h2 className="font-['Fraunces'] font-light text-display-l text-[#1A1A1A] max-w-[28ch]">
            {heading}
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-10 md:mb-24">
          {options.map((option) => (
            <div key={option._key} className="flex flex-col group cursor-pointer">
              <p className="font-['DM_Mono'] uppercase tracking-[0.22em] text-[11px] text-[#5A6673] mb-4">
                {option.label}
              </p>
              <h3 className="font-['Fraunces'] text-display-m text-[#1A1A1A] mb-8">
                {option.title}
              </h3>
              <div className="mt-auto">
                <span className="inline-flex items-center font-['DM_Mono'] uppercase tracking-[0.22em] text-[11px] text-[#1A1A1A] border-b border-[#C8CDD2] pb-1 group-hover:border-[#1A1A1A] transition-colors">
        ...
        <div className="pt-12 border-t border-[#C8CDD2]/50">
          <p className="font-['Fraunces'] italic text-[#5A6673] text-body max-w-[60ch]">
