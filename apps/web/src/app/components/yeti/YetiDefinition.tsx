...
export const YetiDefinition = ({ page, encodeDataAttribute }: { page?: PageData; encodeDataAttribute?: EncodeDataAttributeCallback }) => {
    ...
    <section className="bg-[#F4F2EC] section-padding">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8">
        ...
        <div
          ...
          data-sanity={paragraphs.length > 0 ? encodeDataAttribute?.(['yetiPage', 'definitionBody']) : undefined}
        >
