...
export default defineType({
  ...
  fields: [
    ...
    defineField({ group: 'route', name: 'routeHeadline', title: 'Route Headline', type: 'text', rows: 2, description: 'Optional full headline above the elevation chart. Overrides the auto-generated headline below.' }),
    defineField({ group: 'route', name: 'routeHeadlineSuffix', title: 'Route Headline — Points Line', type: 'string', description: 'Second part of the auto headline, e.g. "9 points on the line." Leave blank to count waypoints automatically.' }),
