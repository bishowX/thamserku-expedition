...
export function AtlasClosing() {
  return (
    <section className="relative w-full bg-[#1A1A1A] text-white py-32 md:py-48 px-8 overflow-hidden min-h-[800px] flex flex-col justify-center items-center text-center">
      {/* Distant Himalayan Ridgleline */}
      ...
      <div className="relative z-10 max-w-[800px] mx-auto flex flex-col items-center">
        ...
        <h2 className="font-['Radley'] font-light text-5xl md:text-[80px] leading-[1.05] text-white tracking-tight mb-8">
          Not sure which mountain is yours? That is exactly why we begin with a conversation.
        </h2>
        
        <p className="font-['Lexend'] font-light text-[#C8CDD2] text-[17px] leading-relaxed max-w-[60ch] mb-16">
          Share your background, your timing, and your intention. Our expedition desk will respond with the mountain — and the edition — that fits.
        </p>
