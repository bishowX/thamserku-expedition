            ...
            <thead>
              <tr>
                ...
                {mountains.map((mountain, idx) => (
                  <th key={idx} className="pb-12 border-b border-white/10 w-[16.66%]">
            ...
            <tbody>
              {editions.map((edition, rowIdx) => (
                <tr key={rowIdx}>
                  ...
                  {edition.availability.map((isAvailable, colIdx) => (
                    <td key={colIdx} className="py-8 border-b border-white/10 text-center">
                      {isAvailable ? (
