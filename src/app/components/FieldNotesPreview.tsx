...
const notes = [
  {
    ...
    excerpt: "A walk-in is never only a walk-in. It is the first read of weather, of body, of crew, and of how the mountain is breathing this season.",
  ...
  },
  {
    ...
    excerpt: "What an expedition actually feels like when the noise is removed.",
  ...
  },
  {
    ...
    excerpt: "The quiet calculations that decide whether a day is a climbing day.",
    byline: "SIRDAR NOTES · 9 MIN READ",
    cols: 3,
    aspect: "aspect-[4/5]",
    image: "https://images.unsplash.com/photo-1549364472-0972cec89cd8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxDbGltYmVyJTIwbW91bnRhaW4lMjByaWRnZSUyMHNub3d8ZW58MXx8fHwxNzc3NDQ2MzExfDA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    code: "FN / 04 — WEATHER",
    title: "Weather Windows",
    excerpt: "Understanding the brief moments when the atmosphere allows passage to the summit.",
        ...
        <div id="newsletter" className="w-full mt-12 pt-[80px] md:pt-[100px] pb-[80px] md:pb-[100px] border-t border-[#E5E7EB]">
          <div className="max-w-[720px] mx-auto flex flex-col items-center text-center">
            ...
            <div className="flex flex-col gap-2 mb-12">
              <p className="font-['Lexend'] font-light text-[16px] text-[#5A6673] leading-[1.65] max-w-[56ch]">
              ...
              <span className="font-['JetBrains_Mono'] uppercase tracking-[0.22em] text-[10.5px] text-[#5A6673]">
                [CLIENT TO CONFIRM] — QUARTERLY CADENCE PENDING APPROVAL.
              </span>
            </div>
